...
var PartialGraphQLAPI = /** @class */ (function () {
    ...
    PartialGraphQLAPI.prototype.finalize = function (namespace) {
        return new GraphQLAPI(this.apiUrl, this.headers, this.introspectionHeaders, this.transforms, namespace);
    };
    return PartialGraphQLAPI;
}());
exports.PartialGraphQLAPI = PartialGraphQLAPI;
var GraphQLAPI = /** @class */ (function () {
    function GraphQLAPI(url, headers, introspectionHeaders, transforms, namespace) {
    ...
    GraphQLAPI.prototype.toString = function () {
        ...
        transforms =
            this.transforms.length != 0
                ...
                : '';
        var footer = '  )';
        return "".concat(header).concat(namespace).concat(url).concat(headers).concat(introspectionHeaders).concat(transforms).concat(footer);
    };
    return GraphQLAPI;
}());
