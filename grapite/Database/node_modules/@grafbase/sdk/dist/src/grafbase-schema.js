...
var model_1 = require("./connector/dynamodb/model");
...
var GrafbaseSchema = /** @class */ (function () {
    ...
    GrafbaseSchema.prototype.datasource = function (datasource, params) {
        ...
        if (finalDatasource instanceof mongodb_1.MongoDBAPI) {
    ...
    GrafbaseSchema.prototype.model = function (name, fields) {
        ...
        }, new model_1.DynamoDBModel(name));
     ...
     */
    GrafbaseSchema.prototype.decimal = function () {
        return new scalar_1.StringDefinition(typedefs_1.FieldType.Decimal);
    };
    /**
     * Create a new bytes field.
     */
    GrafbaseSchema.prototype.bytes = function () {
        return new scalar_1.BytesDefinition(typedefs_1.FieldType.Bytes);
    };
    /**
     * Create a new bigint field.
     */
    GrafbaseSchema.prototype.bigint = function () {
        return new scalar_1.BigIntDefinition(typedefs_1.FieldType.BigInt);
    };
    /**
