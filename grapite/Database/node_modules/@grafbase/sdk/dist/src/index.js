...
exports.auth = exports.connector = exports.config = exports.g = void 0;
 ...
 */
exports.g = new grafbase_schema_1.GrafbaseSchema();
/**
 * A constructor for a complete Grafbase configuration.
 */
function config(input) {
    return new config_1.Config(input);
}
...
exports.connector = {
    ...
    OpenAPI: function (params) {
        return new openapi_1.PartialOpenAPI(params);
    },
    /**
     ...
     * @param params - The configuration parameters.
     */
    GraphQL: function (params) {
        return new graphql_1.PartialGraphQLAPI(params);
    },
    /**
    ...
    MongoDB: function (params) {
        return new mongodb_1.PartialMongoDBAPI(params);
    }
};
exports.auth = {
    /**
