...
(0, globals_1.describe)('Model generator', function () {
    ...
    (0, globals_1.it)('generates a referenced type', function () {
        ...
        index_1.g.model('User', {
            name: index_1.g.string(),
            address: index_1.g.ref(address).optional()
        });
    ...
    (0, globals_1.it)('generates a list referenced type', function () {
        ...
        index_1.g.model('User', {
            name: index_1.g.string(),
            addresses: index_1.g.ref(address).list()
        });
        (0, globals_1.expect)((0, utils_1.renderGraphQL)((0, index_1.config)({ schema: index_1.g }))).toMatchInlineSnapshot("\n      \"type Address {\n        street: String\n      }\n\n      type User @model {\n        name: String!\n        addresses: [Address!]!\n      }\"\n    ");
    });
    ...
    (0, globals_1.it)('generates a field with a public auth rule', function () {
        index_1.g.model('User', {
            name: index_1.g.string().auth(function (rules) {
                rules.public();
            })
        });
    ...
    (0, globals_1.it)('generates a composite type field with a single auth rule', function () {
        ...
        index_1.g.model('User', {
            address: index_1.g.ref(address).auth(function (rules) {
                rules.private();
            })
        });
    ...
    (0, globals_1.it)('generates a relation field with a single auth rule', function () {
        var model = index_1.g.model('User', {
            self: index_1.g.relation(function () { return model; }).auth(function (rules) { return rules.private(); })
        });
    ...
    (0, globals_1.it)('generates a resolver to a field', function () {
        index_1.g.model('User', {
            name: index_1.g.string().resolver('a-field')
        });
    ...
    (0, globals_1.it)('generates a cache with unique', function () {
        index_1.g.model('User', {
            name: index_1.g.string().optional().unique().cache({ maxAge: 60 })
        });
    ...
    (0, globals_1.it)('prevents using of whitespaced identifier as the name', function () {
        (0, globals_1.expect)(function () { return index_1.g.model('white space', { name: index_1.g.string() }); }).toThrow('Given name "white space" is not a valid TypeScript identifier.');
    });
    (0, globals_1.it)('prevents using of number-prefixed identifier as the name', function () {
        (0, globals_1.expect)(function () { return index_1.g.model('0User', { name: index_1.g.string() }); }).toThrow('Given name "0User" is not a valid TypeScript identifier.');
    });
    (0, globals_1.it)('prevents using of weird characters identifier as the name', function () {
        (0, globals_1.expect)(function () { return index_1.g.model('!@#$%^&*()+|~`=-', { name: index_1.g.string() }); }).toThrow('Given name "!@#$%^&*()+|~`=-" is not a valid TypeScript identifier.');
    });
    (0, globals_1.it)('prevents using of whitespaced identifier as a field name', function () {
        (0, globals_1.expect)(function () { return index_1.g.model('A', { 'white space': index_1.g.string() }); }).toThrow('Given name "white space" is not a valid TypeScript identifier.');
    });
    (0, globals_1.it)('prevents using of number-prefixed identifier as a field name', function () {
        (0, globals_1.expect)(function () { return index_1.g.model('A', { '0name': index_1.g.string() }); }).toThrow('Given name "0name" is not a valid TypeScript identifier.');
    });
    (0, globals_1.it)('prevents using of weird characters identifier as a field name', function () {
        (0, globals_1.expect)(function () { return index_1.g.model('A', { '!@#$%^&*()+|~`=-': index_1.g.string() }); }).toThrow('Given name "!@#$%^&*()+|~`=-" is not a valid TypeScript identifier.');
    });
});
